...
export default function AddTrip() {
  ...
  const driverOptions = sampleDrivers
    ? sampleDrivers.map((driver: { id: number; name: string }) => ({
        value: driver.name,
        label: driver.name,
      }))
    : [];
      ...
      <div className="fixed inset-0 max-w-4xl mx-auto px-6 py-8 rounded-lg shadow-md mt-20">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <MoneyInput form={form} label="Fare" name="fare" placeholder="" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Selector
                ...
                setSelected={(selectedDriverName: string) => {
                  const selectedDriver = sampleDrivers.find(
                    (driver) => driver.name === selectedDriverName
                  );
                  if (selectedDriver) {
