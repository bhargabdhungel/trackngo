        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center bg-gray-800 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 card animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300 mb-4">
                "Track and Go has transformed our fleet management. The
                real-time tracking feature is a game-changer!"
              </p>
            ...
            <div className="flex flex-col items-center bg-gray-800 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 card animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300 mb-4">
                "The scheduling and driver management tools have significantly
                improved our efficiency."
              </p>
              <h3 className="text-xl font-semibold text-white">Jane Smith</h3>
              <p className="text-gray-400">
                Operations Director at ABC Transport
              </p>
            </div>
            <div className="flex flex-col items-center bg-gray-800 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 card animate__animated animate__fadeIn">
              <div className="w-24 h-24 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <div
                ...
                style={{
                  animation: `zoomIn 0.5s ${index * 0.1 + 0.5}s forwards`,
                }}
              >
                <dt className="order-2 mt-2 text-lg md:text-xl lg:text-2xl font-medium text-gray-400">
                  {stat.name}
                </dt>
                <dd className="order-1 text-3xl md:text-4xl lg:text-5xl font-bold text-white">
                  {stat.value}
                </dd>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-center text-center lg:text-left">
          <div className="lg:w-1/2 lg:pr-8 mb-6 lg:mb-0">
            ...
            <p className="text-lg md:text-xl">
              Your description goes here. Lorem ipsum dolor sit amet,
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mb-6 md:mb-0 flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a href="/vehicle" className="hover:text-gray-200">
                    Vehicles
                  </a>
                </li>
                <li>
                  <a href="/driver" className="hover:text-gray-200">
                    Drivers
                  </a>
                </li>
                <li>
                  <a href="/trip" className="hover:text-gray-200">
                    Trips
                  </a>
                </li>
                <li>
