...
export default function Profile({ id, image, name, contact }: ProfileProps) {
    const noimage = "https://imgs.search.brave.com/xynPF2RX8yrKnvYLoAEpP8H4sadW2BamRD5N6uGqGcg/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzAzLzU5LzU4Lzkx/LzM2MF9GXzM1OTU4/OTE4Nl9KRExsOGRJ/V29CTmYxaXFFa0h4/aFVlZU91bHgwd09D/NS5qcGc"
    const router = useRouter();
    ...
    return (
        <Card className="w-4/5 sm:w-4/5 md:w-1/2 lg:w-1/3">
                ...
                <div className="grid w-full items-center gap-4">
                    <div className="flex sm:flex-col space-y-1.5 items-center sm:justify-center">
                        <Avatar className="sm:h-24 sm:w-24 h-16 w-16 border-1 mt-4">
                            <AvatarImage src={image ? image : noimage} alt="Profile Image" className="object-cover" />
                        </Avatar>
            ...
            <CardFooter className="flex justify-between">
                ...
                <Button
                    onClick={() => { router.push(`/driver/${id}/upload`) }}
                >Upload</Button>
            </CardFooter>
        </Card>
    )
