...
import { deleteVehicleDocument } from "@/app/actions/doc/vehicle";

interface DocumentListProps {
    docs: VehicleDocument[];
}

export function ListVehicleDocs({ docs }: DocumentListProps) {
    const [documents, setDocuments] = useState<VehicleDocument[]>(docs);
    ...
    async function handleDeleteDoc(id: number) {
        try {
            const response = await deleteVehicleDocument(id);
            toast({
