...
export function Navbar({ title }: NavbarProps) {
  return (
    <header className="sticky top-0 h-[56px] z-10 w-full bg-background/95 shadow backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:shadow-secondary">
